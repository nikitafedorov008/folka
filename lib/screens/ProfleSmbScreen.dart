...
class ProfileSMDScreen extends StatefulWidget {
  final String currentUserId;
  final String userId;

  ProfileSMDScreen({this.currentUserId, this.userId});

  @override
  _ProfileSMDScreenState createState() => _ProfileSMDScreenState();
}

class _ProfileSMDScreenState extends State<ProfileSMDScreen> {
