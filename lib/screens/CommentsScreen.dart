    ...
    return FutureBuilder(
      ...
      builder: (BuildContext context, AsyncSnapshot snapshot) {
        ...
        return ListTile(
          ...
          title: Text(author.name, style: TextStyle(fontFamily: 'ProductSans'),),
          subtitle: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: <Widget>[
              Text(comment.content, style: TextStyle(fontFamily: 'ProductSans'),),
              SizedBox(height: 6.0),
              Text(
          ...
          children: <Widget>[
            ...
            Expanded(
              child: TextField(
                ...
                decoration:
                InputDecoration.collapsed(hintText: 'Write a messege...',
